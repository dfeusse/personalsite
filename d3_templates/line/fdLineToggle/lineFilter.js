var regions = {"SAS": "South Asia", "ECS": "Europe and Central Asia", "MEA": "Middle East & North AAfrica", 
...
function onmouseover(d, i) {
	...
	blurb += "<p>On average: a life expectency of  " + Math.round(countryVals['startVal']) + " years in " + countryVals['startYear'] 
			+ " and " + Math.round(countryVals['endVal']) + " years in " + countryVals['endYear'] + ", ";
	if (percentChange >= 0) {
		blurb += "an increase of " + Math.round(percentChange) + " percent."
	} else {
		blurb += "a decreae of " + -1 * Math.round(percentChange) + " percent."
	}
	blurb += "</p";
